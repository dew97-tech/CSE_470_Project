            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a id="create-new" type="button" class="btn btn-primary float-right" href="{{route('teachers.create')}}">Add New</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger" href="{{route('teachers.destroy', $teacher->id)}}" onclick="return confirm('Are you sure?')">
